...
function display() {
  ...
  game.i[1].x = (((((game.i[1].count + 2) * (game.u[1].count + 1)) * ((game.i[2].count + 1) * (game.u[2].count + 1))) ** ((game.i[3].count + 1) * (1 + (game.u[3].count / 10))))) * (1 + Math.log10(game.pp.x + 1)) - ((((game.i[1].count * (game.u[1].count + 1)) * ((game.i[2].count + 1) * (game.u[2].count + 1))) ** ((game.i[3].count + 1) * (1 + (game.u[3].count / 10))))) * (1 + Math.log10(game.pp.x + 1));
